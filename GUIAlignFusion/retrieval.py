...
from combiner import Combiner  # 确保combiner.py在相同目录
...
class Config:
    ...
    model_path = "/home/CLIP4/CLIP4Cir/combiner_training1/RN50x4_2025-07-03_23:51:16/saved_models/combiner3_combiner_final.pt"
...
def retrieve_images(reference_image, text, index_features, index_names, clip_model, combiner, preprocess, k=10):
    ...
    with torch.no_grad():
        ...
        similarities = query_features @ index_features.T
    ...
    # 获取完整图像路径
    topk_paths = [os.path.join(Config.image_lib_path, f"{img_id}.png") for img_id in topk_ids]
...
def main():
    ...
    # 示例查询 (可替换为实际输入)
    input_image_path = "/home/CLIP4/CLIP4Cir/GUI/images/ED630E823B.png"
